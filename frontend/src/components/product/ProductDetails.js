  ...
  return (
    <div className='container border'>
          ...
          <div className='row mt-4'>
          {
            product?.images?.map((image) =>{
              return <div className='col-4'>
                      ...
                      height="100px" className={`${activeImage=== image?.url ? "border border-4 border-info":" "}`}
      ...
      <div>
        ...
        elit. Expedita animi voluptatum earum voluptas quaerat odio similique, 
        rem id voluptatibus molestiae perspiciatis temporibus inventore ex fugiat nihil quis velit laudantium sequi 
        aspernatur consectetur dolorum? Quam libero perspiciatis quis aspernatur rem fuga numquam facere id. Esse ipsa obcaecati provident officia, ex rerum!
        </p>
      </div>
    </div>
    </div>
