...
router.route('/allReviews').get(isAuthenticatedUser,getReviews)

router.route('/admin/deleteReviews').delete(isAuthenticatedUser,authorizeRoles('admin'),deleteReview)
